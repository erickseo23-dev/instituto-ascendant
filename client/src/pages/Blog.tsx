...
const blogArticles = [
  {
    id: 1,
    slug: "meditacion-ascendente-transformacion",
    title: "Meditación Ascendente: El Camino hacia la Transformación Interior",
    excerpt: "Descubre cómo la Meditación Ascendente puede transformar tu vida a través de la conexión consciente con tu verdadera naturaleza.",
  ...
  {
    id: 2,
    slug: "ks-healing-sanacion-energetica",
    title: "KS Healing: La Energía Crística para tu Sanación",
    excerpt: "Entiende cómo KS Healing Systems utiliza la energía crística para sanar profundamente a nivel físico, emocional y espiritual.",
    author: "YOHEV",
  ...
  {
    id: 3,
    slug: "consciencia-creadora-poder-pensamiento",
    title: "Consciencia Creadora: El Poder de tu Pensamiento",
    excerpt: "Aprende cómo tu consciencia crea tu realidad y cómo puedes utilizar este poder para manifestar la vida que deseas.",
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          <AnimatedSection>
            ...
            <p className="text-white/70 text-lg max-w-2xl">
              Artículos, reflexiones y guías prácticas para tu crecimiento de consciencia y transformación personal.
            </p>
          </AnimatedSection>
        </div>
      </section>
                    ...
                    <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                      ...
                      <div className="relative h-48 overflow-hidden bg-[#E8E4DF]">
                        ...
                        <div className="absolute top-4 left-4">
                          <span className="inline-block px-3 py-1 bg-[#C4963C] text-white text-xs font-semibold rounded-full">
                            {article.category}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        <h3 className="font-serif text-xl font-semibold text-[#2D2D2D] mb-3 group-hover:text-[#C4963C] transition-colors line-clamp-2">
                          {article.title}
                        </h3>
                        <p className="text-[#2D2D2D]/60 text-sm leading-relaxed mb-4 flex-grow line-clamp-3">
                          {article.excerpt}
                        </p>

                        {/* Meta */}
                        <div className="flex items-center justify-between text-xs text-[#2D2D2D]/50 border-t border-[#E8E4DF] pt-4">
                        ...
                        {/* CTA */}
                        <div className="mt-4 flex items-center gap-2 text-[#C4963C] font-semibold text-sm group-hover:gap-3 transition-all">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 text-center">
          <AnimatedSection>
            ...
            <p className="text-[#2D2D2D]/70 mb-8 max-w-2xl mx-auto">
              Accede a más contenido exclusivo, meditaciones guiadas y programas de transformación en nuestra app Ascendente.
            </p>
            <a
            ...
            >
              Explorar Recursos Gratuitos <ArrowRight className="w-4 h-4" />
            </a>
          </AnimatedSection>
        </div>
      </section>
