    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="bg-[#0f1520] py-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="text-white font-serif mb-4" style={{ fontSize: "clamp(3rem, 10vw, 7rem)", lineHeight: 1 }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-amber-400 font-serif mb-1" style={{ fontSize: "clamp(1.8rem, 5vw, 3rem)" }}>
                  {stat.prefix || ""}
