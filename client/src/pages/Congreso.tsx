...
export default function Congreso() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a12] text-white font-['Cormorant_Garamond',serif]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a12]/90 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-[#c9a84c] text-[#0a0a12] px-6 py-2 text-sm font-bold uppercase tracking-widest font-['Montserrat',sans-serif] hover:bg-[#e0bf6a] transition-colors"
          >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#c9a84c] text-[#0a0a12] px-10 py-4 text-sm font-bold uppercase tracking-[0.3em] font-['Montserrat',sans-serif] hover:bg-[#e0bf6a] transition-colors"
          >
      ...
      {/* TARIFAS / INSCRIPCIÓN - OCULTO TEMPORALMENTE */}
      {false && <section id="inscripcion" className="py-24 px-6 bg-[#0f0f1a]">
        <div className="max-w-5xl mx-auto">
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#c9a84c] text-[#0a0a12] px-12 py-5 text-sm font-bold uppercase tracking-[0.3em] font-['Montserrat',sans-serif] hover:bg-[#e0bf6a] transition-colors"
          >
